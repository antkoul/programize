...
app.post('/items', (req, res) => {	
	...
	//console.log('201 - The TODO was added')
})

app.put('/items/:id', (req, res) => {
	//console.log('204 - The TODOs were updated.')
  	res.status(204).end()
})
...
app.get('/items', (req, res) => {
	...
	//res.sendFile('/Users/antonioskoulouris/Desktop/Programize/todolist/index.html') //dokimastiko
